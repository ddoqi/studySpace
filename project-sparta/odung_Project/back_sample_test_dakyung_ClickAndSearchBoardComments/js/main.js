...
// 해당 타겟게시물 조회 & 타겟게시물 댓글조회
import { saveTargetComments, targetCommentsSearch, pageMoveAndSearchAndCommentsSearch} from "./pageJs/comment.js";
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.pageMoveAndSearchAndCommentsSearch=pageMoveAndSearchAndCommentsSearch;

  ////save_target_comment,targetCommentsSearch
