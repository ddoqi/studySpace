...
let Static자식 = new StaticUser();
console.log(Static자식.x); //결과값 : undefined

class StaticExtends자식 extends StaticUser {}
...
// //🌸 namespace 🌸
// 옛날엔, import, export가 없어서
// 어디 ts파일의 타입변수인지 찾을수가 없었으니
// 이렇게 namespace라는 키워드를 활용해서 써주었었다.
// namespace 기능? 타입변수 숨기기 라고 보면 됌
namespace 네임스페이스 {
